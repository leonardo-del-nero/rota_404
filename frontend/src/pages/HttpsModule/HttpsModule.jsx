    ...
    return (
      ...
      >
        <div className={`flex-center ${styles.introAnimation}`}>
          <motion.div animate={{ x: [-100, 0], opacity: [0, 1] }} transition={{ duration: 1 }} className={styles.introMail}>
            <Mail size={50} />
          </motion.div>
          <motion.div initial={{ opacity: 0, scale: 2 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: 1, duration: 0.5, type: 'spring' }} className={styles.introLock}>
            <Lock size={60} />
          </motion.div>
        </div>
      </ModuleIntro>
